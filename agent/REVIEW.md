...
**Write the review session log entry** — append to `wiki/log.md` (newest first) using the canonical format from the agent context file's **Session Log** section (see CLAUDE.md / AGENTS.md / GEMINI.md / CURSOR.md):
