...
The canonical log entry format is defined in the **Session Log** section of the agent context file (CLAUDE.md / AGENTS.md / GEMINI.md / CURSOR.md). Every session produces one entry in `wiki/log.md`, newest first.
